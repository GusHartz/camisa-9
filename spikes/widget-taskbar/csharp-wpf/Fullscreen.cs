...
/// borderless-fullscreen (só reporta QUNS_BUSY) — então combina com checagem de geometria
/// (a janela em foreground cobre o monitor inteiro).
/// </summary>
internal static class Fullscreen
{
    public static bool IsActive(IntPtr selfHwnd)
    {
        ...
        if (!NativeMethods.GetWindowRect(fg, out RECT wr)) return false;
