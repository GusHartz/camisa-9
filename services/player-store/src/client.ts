...
// SPEC-035 (Fatia 4 — Neon): driver endurecido p/ Neon (SSL + autosuspend) + endpoint de
// migrations separado (direct/unpooled). Helpers duplicados do world-store de propósito:
// serviços independentes, sem import cruzado (é glue de config, não regra de domínio).
