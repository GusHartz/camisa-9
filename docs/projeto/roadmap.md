...
| 0.2 | **Camada de dados + seed do mundo** 🚧 | Schema de ligas/clubes/atletas/temporadas; migrations versionadas. Persiste o que o spike (0.1.5) provou em memória. *(Fatiada em 5: **Fatia 1 — snapshot consultável do mundo semeado em Postgres** ✅ SPEC-013, 2026-07-16; tier `services/world-store` + Drizzle + migration `0000` + round-trip reconciliado com o golden. Próximas: 2 — publicador de rodada transacional · 3 — persistir viragens · 4 — Neon branch-por-ambiente · 5 — Pirâmide Elástica.)* |
